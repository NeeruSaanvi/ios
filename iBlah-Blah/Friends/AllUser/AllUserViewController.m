...
- (void)viewDidLoad {
    ...
    [appDelegate().socket emit:@"showAllUsers" with:@[USERID,currentAllPostPage ,@""]];
    // arryFrnd=@[@"",@"",@"",@"",@"",@"",@"",@"",@"",@""];
    ...
    if (!self.loadingAllPost) {
        ...
        if (endScrolling >= scrollView.contentSize.height)
        {
            ...
            if(currentPageAll<countAllPost-1){
                ...
                [appDelegate().socket emit:@"showAllUsers" with:@[USERID,currentAllPostPage ,strText]];
                
            }else{
                self.loadingAllPost=NO;
                self.noMoreResultsAvailAllPost=YES;
                [self.tblAllUser reloadData];
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    [appDelegate().socket emit:@"showAllUsers" with:@[USERID,currentAllPostPage ,searchBar.text]];
