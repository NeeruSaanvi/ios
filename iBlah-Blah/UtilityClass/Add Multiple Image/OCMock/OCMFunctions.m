...
{
    if((mock != nil) && (objc_getAssociatedObject(aClass, (__bridge const void * _Nonnull)(OCMClassMethodMockObjectKey)) != nil))
    ...
    objc_setAssociatedObject(aClass, (__bridge const void * _Nonnull)(OCMClassMethodMockObjectKey), mock, OBJC_ASSOCIATION_ASSIGN);
}
...
OCClassMockObject *OCMGetAssociatedMockForClass(Class aClass, BOOL includeSuperclasses)
{
    ...
    do
    {
        mock = objc_getAssociatedObject(aClass, (__bridge const void * _Nonnull)(OCMClassMethodMockObjectKey));
...
{
    if((mock != nil) && (objc_getAssociatedObject(anObject, (__bridge const void * _Nonnull)(OCMPartialMockObjectKey)) != nil))
        [NSException raise:NSInternalInconsistencyException format:@"Another mock is already associated with object %@", anObject];
    objc_setAssociatedObject(anObject, (__bridge const void * _Nonnull)(OCMPartialMockObjectKey), mock, OBJC_ASSOCIATION_ASSIGN);
}

OCPartialMockObject *OCMGetAssociatedMockForObject(id anObject)
{
    return objc_getAssociatedObject(anObject, (__bridge const void * _Nonnull)(OCMPartialMockObjectKey));
}
