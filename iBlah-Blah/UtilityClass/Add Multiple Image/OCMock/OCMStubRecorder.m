...
{
	[[self stub] addInvocationAction:[[OCMReturnValueProvider alloc] initWithValue:anObject]];
	return self;
}

- (id)andReturnValue:(NSValue *)aValue
{
    [[self stub] addInvocationAction:[[OCMBoxedReturnValueProvider alloc] initWithValue:aValue]];
	return self;
}

- (id)andThrow:(NSException *)anException
{
    [[self stub] addInvocationAction:[[OCMExceptionReturnValueProvider alloc] initWithValue:anException] ];
	return self;
}

- (id)andPost:(NSNotification *)aNotification
{
    [[self stub] addInvocationAction:[[OCMNotificationPoster alloc] initWithNotification:aNotification] ];
	return self;
}

- (id)andCall:(SEL)selector onObject:(id)anObject
{
    [[self stub] addInvocationAction:[[OCMIndirectReturnValueProvider alloc] initWithProvider:anObject andSelector:selector]];
	return self;
}

- (id)andDo:(void (^)(NSInvocation *))aBlock 
{
    [[self stub] addInvocationAction:[[OCMBlockCaller alloc] initWithCallBlock:aBlock] ];
	return self;
}

- (id)andForwardToRealObject
{
    [[self stub] addInvocationAction:[[OCMRealObjectForwarder alloc] init] ];
    return self;
}
