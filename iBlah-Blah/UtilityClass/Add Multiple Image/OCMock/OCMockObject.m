...
- (id)stub
{
	return [[OCMStubRecorder alloc] initWithMockObject:self];
}

- (id)expect
{
    return [[OCMExpectationRecorder alloc] initWithMockObject:self];
}
...
- (id)verifyAtLocation:(OCMLocation *)location
{
    ...
    {
        firstException = exceptions.firstObject ;
    }
    if(firstException)
	{
   ...
   // [firstException release];
    ...
    return [[OCMVerifier alloc] initWithMockObject:self];
}
